...
class PwmController:
    ...
    def __init__(self) -> None:
        ...
        self.kit.servo[0].set_pulse_width_range(500, 2500)  # yaw
        self.kit.servo[1].set_pulse_width_range(500, 2500)  # pitch one
        self.kit.servo[2].set_pulse_width_range(500, 2500)  # pitch two
        self.kit.servo[3].set_pulse_width_range(500, 2500)  # roll
        self.kit.servo[3].set_pulse_width_range(500, 2500)  # roll
