...
class Rover:
    ...
    # have to re do this when i re write the servo class anyway  # idead, have a run method for each class and then just ahve the one thread loop thoruhg all the run methods every x millis
