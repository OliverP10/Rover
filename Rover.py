...
class Rover:
    ...
    def load_control_mappings(self) -> None:
        self.control_mappings['19'] = self.movement.run_steering_mode
        self.control_mappings['18'] = self.movement.set_steering
        self.control_mappings['17'] = self.movement.set_movement_mode
    ...
    def load_key_mappings(self) -> None:
        self.key_mappings["u_d"] = self.arm.yaw_turn_clockwise
        self.key_mappings["u_u"] = self.arm.yaw.stop_turn
        self.key_mappings["j_d"] = self.arm.yaw_turn_counter_clockwise
        self.key_mappings["j_u"] = self.arm.yaw.stop_turn
        self.key_mappings["i_d"] = self.arm.pitch1_turn_clockwise
        self.key_mappings["i_u"] = self.arm.pitch1.stop_turn
        self.key_mappings["k_d"] = self.arm.pitch1_turn_counter_clockwise
        self.key_mappings["k_u"] = self.arm.pitch1.stop_turn
        self.key_mappings["o_d"] = self.arm.pitch2_turn_clockwise
        self.key_mappings["o_u"] = self.arm.pitch2.stop_turn
        self.key_mappings["l_d"] = self.arm.pitch2_turn_counter_clockwise
        self.key_mappings["l_u"] = self.arm.pitch2.stop_turn
        self.key_mappings["p_d"] = self.arm.roll_turn_clockwise
        self.key_mappings["p_u"] = self.arm.roll.stop_turn
        self.key_mappings[";_d"] = self.arm.roll_turn_counter_clockwise
        self.key_mappings[";_u"] = self.arm.roll.stop_turn

        self.key_mappings["[_d"] = self.arm.claw_open
        self.key_mappings["[_u"] = self.arm.claw.stop
        self.key_mappings["'_d"] = self.arm.claw_close
        self.key_mappings["'_u"] = self.arm.claw.stop
